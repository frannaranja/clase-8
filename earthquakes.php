...
<div class="col-sm-12 col-lg-10 col-lg-offset-1">
  <section>
    ...
    <?php $cl++ ;?>
    <li <?php if ($json_data['features'][$n]['properties']['mag'] >= 6){?> style="color:RGB(224, 21, 36);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 5){ ?> style="color:RGB(149, 83, 84);" <?php } elseif($json_data['features'][$n]['properties']['mag'] >= 4){ ?> style="color:RGB(210, 152, 152);" <?php } elseif($json_data['features'][$n]['properties']['mag'] <= 4){ ?> class="content hidden" <?php }else{ ?> style="color:RGB(100, 100, 100);" <?php };?>>
